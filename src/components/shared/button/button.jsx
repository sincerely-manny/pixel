...
const styles = {
  ...
  base: 'font-semibold inline-flex justify-center items-center text-center hover:scale-105 active:scale-95 disabled:opacity-80 disabled:hover:scale-100 disabled:active:scale-100 transition-all',
  ...
  size: {
    sm: 'text-sm rounded-lg px-[1.125rem] py-2.5',
  ...
  //       Check out an example by a link above for better understanding
  theme: {
    'white-filled': 'bg-grey-98 text-black',
    'purple-filled': 'bg-primary-1 text-black',
  },
};
